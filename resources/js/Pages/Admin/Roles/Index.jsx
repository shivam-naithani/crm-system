    ...
    return (
        ...
        >
            ...
            <div className="p-6 space-y-6">
                ...
                {/* SUCCESS MESSAGE */}
                {flash?.success && (
                    <div className="p-3 bg-green-100 text-green-700 rounded-md shadow-sm">
                        {flash.success}
                    </div>
                )}
                                        ...
                                        users.map((user) => (
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="leading-tight">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span
                                                                className={`text-xs px-2 py-0.5 rounded ${roleStyles[user.role]}`}
                                                            >
                                                                {user.role}
                                                            </span>
                                                        </div>
                                                ...
                                                <select
                                                    ...
                                                    className={`min-w-[110px] text-sm border rounded-md px-2 py-1 focus:ring-2 focus:ring-indigo-500 focus:outline-none ${
                                                        loadingUser === user.id
